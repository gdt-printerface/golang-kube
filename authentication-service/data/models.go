...
func (u *PostgresRepository) ResetPassword(user User, password string) error {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *PostgresRepository) PasswordMatches(user User, plainText string) (bool, error) {
