...
func (u *PostgresTestRepository) ResetPassword(user User, password string) error {
	return nil
}

func (u *PostgresTestRepository) PasswordMatches(user User, plainText string) (bool, error) {
	return true, nil
}
